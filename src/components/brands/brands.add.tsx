...
import { IconButton, Grid, Button, Label, Input, Text, Box, Flex, Spinner } from 'theme-ui';
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onFormSubmit)}>
        ...
        <Box variant={CustomVariants.COLLAPSE_SECTION}>
          <Text mb="6" sx={{ fontFamily: 'IBMPlexSansMedium' }}>
            Address
          </Text>
          <Grid gap={10} columns={[2, null, 3]}>
            <Box variant={CustomVariants.INPUT_WRAP}>
        ...
        <Flex variant={CustomVariants.COLLAPSE_FOOTER}>
          <Button variant={EnumButtonVariants.PRIMARY} type="submit" disabled={fetching} sx={{ mr: 6 }}>
            Save
